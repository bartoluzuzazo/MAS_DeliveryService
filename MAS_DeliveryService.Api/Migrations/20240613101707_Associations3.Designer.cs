...
namespace MAS_DeliveryService.Api.Migrations
{
    ...
    [Migration("20240613101707_Associations3")]
    partial class Associations3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ItemOrderItem", b =>
                {
                    ...
                    b.HasOne("MAS_DeliveryService.Api.Domain.Items.Item", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderOrderItem", b =>
                {
                    ...
                    b.HasOne("MAS_DeliveryService.Api.Domain.Orders.Order", null)
                        .WithMany()
