...
namespace MAS_DeliveryService.Api.Migrations
{
    ...
    [Migration("20240612180445_Associations2")]
    partial class Associations2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAS_DeliveryService.Api.Domain.Items.Item", b =>
                {
                    b.HasOne("MAS_DeliveryService.Api.Domain.OrderItems.OrderItem", null)
                        .WithMany("Items")
                        .HasForeignKey("ItemId");

                    b.HasOne("MAS_DeliveryService.Api.Domain.OrderItems.OrderItem", "OrderItem")
                        .WithMany()
                        .HasForeignKey("OrderItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MAS_DeliveryService.Api.Domain.PackageItems.PackageItem", "PackageItem")
                        .WithMany()
